            ...
            <form className="contact-form w-full lg:w-5/12 px-5">
              <div className="w-full mb-5 flex items-center justify-between flex-wrap">
                <input
                  type="text"
                  placeholder="Name"
                  className="mb-5 lg:mb-0 w-[100%] lg:w-[48%] h-[60px] px-3 border-solid rounded-2xl outline-none"
                />
                <input
                  type="text"
                  placeholder="Email"
              ...
              <div className="flex items-center justify-center mb-5">
                <input
                  type="text"
                  placeholder="Subject"
                  className="w-full h-[60px] px-3 rounded-2xl outline-none"
                />
              </div>
