...
const Contact = () => {
  return (
    <div className="align-middle justify-center lg:pt-28">
          ...
          <div className='hidden lg:flex lg:items-center lg:justify-center'>
              <div className='reason-parent w-11/12 lg:w-7/12 flex items-center justify-between lg:justify-between py-10'>
                  <Zoom><div className='lg:flex lg:items-center lg:justify-center'><div className='flex items-center justify-center '><img src={location} alt='' className='w-8 lg:w-5/12 md:w-2/6'/></div> <p className='text-sm font-thin mt-2 lg:font-bold lg:mt-0'>85 Howord St, Toronto</p></div></Zoom>
                  ...
                  <Zoom><div className='lg:flex lg:items-center lg:justify-center'><div className='flex items-center justify-center'><img src={user} alt='' className='w-8 lg:w-5/12 md:w-2/6' /></div>  <p className='text-sm font-thin lg:font-bold mt-3 lg:mt-0'> (+234) 07056882004</p></div></Zoom>
              </div>
          </div>
              ...
              <Zoom>
                  <form className="contact-form w-full lg:w-5/12 px-5">
                      <div className="w-full mb-5 flex items-center justify-between flex-wrap">
                            ...
                            <input type="text" placeholder="Email" className="w-[100%] lg:w-[48%] h-[60px] px-3 rounded-2xl outline-none"/>
                      </div>
