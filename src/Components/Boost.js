    ...
    <section className='boost'>
        <div className='boost-container lg:flex lg:items-center lg:justify-between lg:flex-wrap lg:px-40 lg:py-14 px-5'>
            <div className='boost-text w-full lg:w-5/12'>
                <Zoom><h3 className='text-gray-900 font-extrabold text-4xl text-center lg:text-left lg:text-5xl'>Boost Your Business up to a <span className='spn'>High Level</span></h3></Zoom>
                <Zoom><p className='text-center lg:text-left mt-5 text-gray-700 lg:text-lg'>
