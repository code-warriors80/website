...
const Boost = () => {
  return (
    <section className='boost'>
        <div className='boost-container lg:flex lg:items-center lg:justify-around lg:flex-wrap px-50  text-center lg:text-left'>
            ...
            <img src={flyer} alt=''className='w-full lg:w-4/12 px-10 xl:px-50 my-14'/>
        </div>
    </section>
  )
}
