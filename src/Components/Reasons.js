  ...
  return (
    <div className=" align-middle justify-center pt-28">
        <section className='reason'>
              ...
              <Zoom><p className='mt-5 px-5 text-center text-sm lg:text-lg font-thin lg:pb-10 text-gray-400'>Unify your business data in one simple ecomerce dashboard</p></Zoom>
