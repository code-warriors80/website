                              ...
                              <div className='footer-parent lg:flex items-center  justify-center md:flex md:items-start md:justify-around flex-wrap py-12'>
                                             ...
                                             <div className='footer-address'>
                                                            ...
                                                            <div className='myaddresslist'>
                                                                           ...
                                                                           <div className='flex items-center justify-center lg:justify-start my-5 lg:text-xl lg:mt-10'><img src={loaction} alt='' className='w-5  mr-5'/>  <p className='text-gray-500 text-sm'>Blk 45 officers quarters chindit cantoonment<br/>Sabon gari lga, Zaria ,Kaduna state</p></div>
