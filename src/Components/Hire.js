  ...
  return (
    <section className='hire flex items-center justify-center'>
               <div className='high-container flex justify-around w-11/12 lg:w-10/12 lg:flex lg:justify-between lg:pt-20'>
                              ...
                              <div className='high-text text-center py-10 lg:relative lg:bottom-20 '>
                                             ...
                                             <Zoom><div className='flex justify-center lg:justify-center'>
                                                               <a href='/' className='bg-white py-2 px-3 lg:py-4 lg:px-8 text-indigo-500 font-thin lg:font-semibold hover:animate-bounce delay-100'>Hire Us</a>         
                                             </div></Zoom>
