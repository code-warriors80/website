...
const About = () => {
  return (
    <section>
            <h2 className='heading text-center mt-16 lg:mt-0 text-3xl lg:text-5xl'><img src={robot} alt='' className='animate-bounce w-10 lg:w-16' />About <span>Our Team</span></h2>
              <p className='mt-5 px-5 text-center text-sm mb-10 lg:mb-0 lg:text-sm font-thin lg:pb-10 text-gray-400'>What Makes us unique and why should you consider using our services</p>
              ...
              <div>
                <div className='lg:flex lg:items-center lg:justify-between lg:flex-wrap lg:px-40 lg:py-14 px-5'>
                    ...
                    <div className='boost-text w-full lg:w-6/12'>
                        <h3 className='text-gray-900 font-extrabold text-4xl lg:text-5xl'>Offering The Best IT Services To  <span>Our Clients</span></h3>
